...
from .serializers import (
    ClienteSerializer, FuncionarioSerializer, OperadorSerializer, 
    ServicoSerializer, ServicoPrestadoSerializer, PagamentoSerializer, 
    DespesaSerializer, FluxoCaixaSerializer, OperacaoSerializer, 
    SalarioSerializer
)
